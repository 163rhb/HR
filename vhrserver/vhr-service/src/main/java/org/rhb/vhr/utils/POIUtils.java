...
public class POIUtils {
    ...
    public static ResponseEntity<byte[]> employeeToExcel(List<Employee> list) {
        ...
        docInfo.setManager("raohaibo");
        docInfo.setCompany("org.rhb");
        SummaryInformation summInfo = workbook.getSummaryInformation();
        summInfo.setTitle("员工信息表");
        summInfo.setAuthor("rhb");
        summInfo.setComments("本文档由rhb提供");
                            ...
                            case STRING:
                                ...
                                switch (k) {
                                    ...
                                    case 13:
                                        ...
                                        break;
                                    case 14:
                                        int positionIndex = allPositions.indexOf(new Positions(cellValue));
